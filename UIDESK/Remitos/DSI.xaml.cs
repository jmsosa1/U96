...
{
    /// <summary>
    /// Lógica de interacción para DSI.xaml
    /// </summary>
    public partial class DSI : MaterialWindow
    {
        ...
        private bool productosPorDeposito(object obj)
        {
            ...
            return producto.IdDeposito == _iddepo && producto.TipoProducto == "Indumentaria"; // aca usamos el id del deposito  debe ser desde el deposito elejido
        }
        ...
        private void BtnAceptar_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (_valido)
            {
                ...
                else
                {
                    ...
                    {
                        PrintIndumentaria printRemito = new PrintIndumentaria(_ultimoIddocumento);
        ...
        private void GrabarEncabezadoEnBD()
        {
            ...
            documento.IdTipoRem = 8;// salida de indumentaria
