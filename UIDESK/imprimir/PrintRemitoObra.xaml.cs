...
{
    /// <summary>
    /// Lógica de interacción para PrintRemitoObra.xaml
    /// </summary>
    public partial class PrintRemitoObra : Window
    {
        ...
        public PrintRemitoObra(int iddocumento) //constructor con parametro del id documento
        {
            InitializeComponent();
            _iddocu = iddocumento;
